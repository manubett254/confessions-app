...
Revision ID: aacb54126403
Revises: 
Create Date: 2025-06-23 16:25:49.234958
...
def upgrade():
    ...
    op.create_table('confession_reaction',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('emoji', sa.String(length=10), nullable=True),
    sa.Column('confession_id', sa.Integer(), nullable=True),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('timestamp', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['confession_id'], ['confession.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
...
def downgrade():
    ...
    op.drop_table('confession_reaction')
